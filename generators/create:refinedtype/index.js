...
module.exports = class extends Generator {
  ...
  initializing() {
    ...
    const determineInputType = (baseType) => {
    ...
    const options = {
      ...
      inputType: determineInputType(this.options.baseType)
    };
  ...
  writing() {
    ...
    [
      ...
      {
        src: "errors/error.ts",
        dest: errorDestPath + "/Invalid" + defaults.typeName + "DataError.ts"
      },
      {
        src: "errors/error.spec.ts",
        dest: errorDestPath + "/Invalid" + defaults.typeName + "DataError.spec.ts"
      },
      {
        src: "errors/index.ts",
