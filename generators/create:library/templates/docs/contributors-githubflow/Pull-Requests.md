...
4. create a new branch on your local computer: `git checkout -b feature/<my-feature>`
5. work on your feature
6. commit it, and push it back up to your fork

When you're ready to submit your pull request, please make sure it's a pull request against our `master` branch.
...
2. does the pull request apply cleanly against our `master` branch?
